    ...
    **New Launch Specialist**
    ...
    ```json
    {
      ...
      "strategy": {
        ...
        "execution_method": "Jito bundles with MEV protection",
...
<Tabs>
  <Tab title="Cross-DEX Arbitrage">
    **Multi-Exchange Profit Mining**
    ...
    interface ArbitrageBlueprint {
      ...
      exchanges: ["Jupiter", "Raydium", "Orca", "Phoenix"];
      
      detection: {
        min_spread: 0.5%;           // 0.5% minimum profit
        max_trade_size: 50_SOL;     // Per arbitrage trade
      ...
      execution: {
        ...
        mev_protection: true;       // Jito bundle execution
  ...
  <Tab title="Triangular Arbitrage">
    **Multi-Hop Profit Cycles**
    ...
    - **Route Discovery**: SOL → TOKEN → USDC → SOL
    ...
    **Best For**: Large capital amounts (10+ SOL)
  </Tab>
</Tabs>
  ...
  <Tab title="Yield Maximizer">
    **Dynamic Pool Management**
    ...
    class YieldMaximizerConfig:
        def __init__(self):
            self.target_pools = [
                'SOL/USDC',     # Stable, high volume
                'RAY/SOL',      # Native DEX token
                'JUP/SOL',      # High APY potential
            ]
...
<Steps>
  <Step title="Select Blueprint">
    **Choose Your Strategy**
    ...
    interface BlueprintFilter {
      ...
      minCapital: number;           // Minimum SOL required
    ...
    **Customize Your Agent**
    ...
    ```json
    {
      ...
      "execution_preferences": {
        ...
        "mev_protection": true,       // Use Jito bundles
  ...
  <Step title="Deploy & Fund">
    **Launch Your Agent**
    ...
    1. **Generate Agent Wallet**: Create dedicated keypair
    2. **Deploy Smart Contract**: Deploy agent program on-chain
    3. **Fund Agent**: Transfer SOL to agent wallet
...
<Steps>
  ...
  <Step title="Start Small">
    Deploy your first agent with 1-2 SOL to learn the platform
  </Step>
