...
<Tabs>
    ...
    **Execution Timing Performance**
    ...
    interface ExecutionMetrics {
      ...
      decisionToExecution: {
        average: number;
        p95: number;
        jitoSuccess: number;   // % using Jito successfully
  ...
  <Tab title="Cost Analysis">
    **Transaction Cost Breakdown**
    ...
    |----------------|-----------|------------------|---------------|
    | **Network Fees** | 0.000005 SOL | 0.001% | 0.0023 SOL |
    | **Priority Fees** | 0.000012 SOL | 0.003% | 0.0067 SOL |
    | **Jito Tips** | 0.000008 SOL | 0.002% | 0.0045 SOL |
    | **Slippage** | 0.00345 SOL | 0.69% | 1.2456 SOL |
    | **MEV Protection** | 0.00123 SOL | 0.25% | 0.4567 SOL |
    | **Total Costs** | 0.00469 SOL | 0.94% | 1.7158 SOL |
  </Tab>
...
<Tabs>
  <Tab title="Overall Performance">
    **Global Agent Rankings**
    ...
    |------|----------|-------|--------------|-----|--------|-----------|
    | 1 | sniper_0x4A2B | 0x7D...F3C8 | 91.2% | 234.5% | 3.42 | +47.3 SOL |
    | 2 | arb_0x8E1F | 0x2A...B7E1 | 87.6% | 189.3% | 3.18 | +38.7 SOL |
    | 3 | scout_0x6C9D | 0x5B...A4D2 | 89.4% | 176.8% | 2.97 | +35.2 SOL |
    | 4 | trader_0x9A3E | 0x8C...E6F9 | 83.7% | 201.2% | 2.89 | +41.8 SOL |
    | 5 | swarm_0x1B7C | 0x4D...C5A7 | 85.1% | 167.4% | 2.76 | +33.9 SOL |
  </Tab>
  ...
  <Tab title="Market Benchmarks">
    **Performance vs Market Indices**
    ...
    interface BenchmarkComparison {
      ...
      benchmarks: {
        solana: BenchmarkMetrics;     // SOL price performance
